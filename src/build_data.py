...
tf.flags.DEFINE_string('input_dataA', '../../Data/BMP_320x280/paired/train',
                       'data A input directory, default: ../../Data/BMP_320x280/paired/train')
tf.flags.DEFINE_string('input_dataB', '../../Data/BMP_320x280/paired/test',
                       'data B input directory, default: ../../Data/BMP_320x280/paired/test')
tf.flags.DEFINE_string('output_dataA', '../../Data/BMP_320x280/tfrecord/train',
                       'data A output directory, default: ../../Data/BMP_320x280/tfrecord/train')
tf.flags.DEFINE_string('output_dataB', '../../Data/BMP_320x280/tfrecord/test',
                       'data B output directory, default: ../../Data/BMP_320x280/tfrecord/test')
...
def data_reader(input_dir, extension='.png', is_shuffle=True):
    file_paths = []
